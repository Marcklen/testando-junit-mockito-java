...
//	}
	...
	//testando metodo find by id porem agora com o uso das exceptiosn para retornar ou nao um objeto
	@Test
	...
	void testCreateWithDataIntegratyViolationException() {
		...
		try {
			...
			assertEquals("E-mail já cadastrado em nosso sistema!", e.getMessage());
		}
	}
